...
@Component({
  selector: 'app-customer-rupture-contrat',
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
  ...
  templateUrl: './customer-rupture-contrat.component.html',
  styleUrl: './customer-rupture-contrat.component.css'
})
export class CustomerRuptureContratComponent implements OnInit {
  ...
  getRupture() {
      ...
      this._rupture.getCustomerRupture(this.employe_matricule).subscribe({
