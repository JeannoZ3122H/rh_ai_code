...
@Component({
  selector: 'app-ch-detail-mission',
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
  ...
  templateUrl: './ch-detail-mission.component.html',
  styleUrl: './ch-detail-mission.component.css'
})
export class ChDetailMissionComponent implements OnInit {
